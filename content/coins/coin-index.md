...
# Coin Index — Master Study Log

Every coin studied in this wiki. One row per coin. Click the case study for full analysis.
...
| 2ra5Id...pump | chloe | Apr 23, 2026 | Video-embedded name — exec milestone tweet (Nikita Bier/X head of product) | Unknown | ✅ Winner | [[coins/chloe]] |
...
|--------|--------|---------|
| Named by credible public figure | ✅ Sam Altman | — |
| Name = exact word from tweet | ✅ | — |
| BC fill < 30 min | ✅ 23 min | — |
| Sniper wave in first 2s | ✅ 16 wallets | — |
| Whale absorption of BC dump at migration | ✅ $169 buy at t+8s | — |
| Post-migration flip at 30–60s | ✅ | — |

---

## How to Add a New Coin

1. Create `coins/[Token_Name]_Case_Study.md` using [[coins/_Template_Coin_Study]]
