...
| Metric | Daily (Apr 22) | Monthly (30d) |
|--------|---------------|---------------|
| Rank | #1 | #1 |
| PnL (SOL) | +83.66 | +3,878.00 |
| PnL (USD) | $7,404 | $343,202 |
| Wins | 45 | 2,031 |
| Losses | 50 | 116 |
| Win rate | 47.4% | **94.6%** 🚨 |
...
A 94.6% monthly win rate across 2,147 trades is statistically implausible for market-based trading:

| Trader | Monthly Win Rate | Trades | Assessment |
|--------|-----------------|--------|------------|
| Cented | **94.6%** | 2,147 | 🚨 Implausible |
...
| Check | Result |
|-------|--------|
| Win rate 75%+ on fast holds | 🚨 94.6% monthly |
...
## Why Cented Could Still Be Legitimate (Low Confidence)

- Maintaining #1 monthly for 30 days is hard to sustain purely by farming — copy traders would adapt
- 94.6% could reflect exceptional token selection in a bull-market month
- 2,147 monthly trades at high volume suggests systematic approach

**These do not override the 4/5 score.** They are reasons to monitor, not reasons to copy.
...
| Action | Verdict |
|--------|---------|
| Copy trades blindly | ❌ Do not |
| Monitor monthly win rate trend | ✅ If drops below 70%, reconsider |
| Verify hold times on Solscan | ✅ Check wallet on-chain |
| Watch daily/monthly rank diverge | ✅ Divergence = farming edge collapsing |
| Re-evaluate | ✅ Monthly |
...
- `kol_scan_leaderboard_apr22.txt` (daily)
- `kol_scan_monthly_apr22.txt` (monthly)
